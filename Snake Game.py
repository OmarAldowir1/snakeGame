...
class SNAKE:
    def __init__(self):
        ...
        self.body_horizontal = pygame.image.load('/Users/YAMAN/Desktop/SnakeProject/Graphics/body_horizontal.png').convert_alpha()
...
class MAIN:
    ...
    def check_collision(self):
        ...
        for block in self.snake.body[1:]:  # to not let the fruit lands on the snake body
...
pygame.time.set_timer(SCREEN_UPDATE, 150)  # snake moves each 150 milliseconds
